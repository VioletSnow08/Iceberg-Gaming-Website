...
<template>
    <div class="h-screen flex w-full bg-img">
        <div class="vx-col flex items-center justify-center flex-col sm:w-1/2 md:w-3/5 lg:w-3/4 xl:w-1/2 mx-auto text-center">
            ...
            <h1 class="sm:mx-0 mx-4 mb-12 text-5xl d-theme-heading-color">Insufficient Permissions</h1>
            <p class="sm:mx-0 mx-4 mb-4 sm:mb-16 d-theme-text-inverse">Either you are not logged in, or you don't have permissions!</p>
