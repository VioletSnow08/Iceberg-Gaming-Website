  ...
  <div>
    ...
    <form-wizard color="rgba(var(--vs-primary), 1)" :title="null" :subtitle="null" finishButtonText="Submit"
      ...
      <tab-content title="Step 2" class="mb-5">
        <div class="vx-row">
          <div class="vx-col md:w-1/2 w-full">
            <vs-input label="How long have you played Arma 3 for?" v-model="arma3Hours" class="w-full mt-4"/>
      ...
      <tab-content title="Step 3" class="mb-5">
        ...
        <h5>By selecting "Submit", you agree that you have you read, understand, and accept all of Rules set forth within the <a href="https://www.guilded.gg/Iceberg-gaming/groups/v3j2vAP3/channels/08ca311e-66fb-45ce-bbbf-c4b34dc69e4a/docs/2016850748" target="_blank">Community Code of Conduct</a>.</h5>
      </tab-content>
    </form-wizard>
