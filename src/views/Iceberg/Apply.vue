  ...
  <div>
    ...
    <form-wizard color="rgba(var(--vs-primary), 1)" :title="null" :subtitle="null" finishButtonText="Submit"
      ...
      <tab-content title="Step 2" class="mb-5">
        <div class="vx-row">
          <div class="vx-col md:w-1/2 w-full">
            <vs-textarea v-model="whyjoin" label="What game(s) do you plan to join us for?" class="mb-0 md:mt-10 mt-6"
                         rows="3"/>
          </div>
          <div class="vx-col md:w-1/2 w-full">
            <vs-textarea v-model="whyjoin" label="How many hours do you have in the game(s) you chose?" class="mb-0 md:mt-10 mt-6"
                         rows="3"/>
          </div>
          <div class="vx-col md:w-1/2 w-full">
            <vs-textarea v-model="whyjoin" label="What hobbies do you like to participate in outside of gaming?" class="mb-0 md:mt-10 mt-6"
                         rows="3"/>
          </div>
          <div class="vx-col md:w-1/2 w-full">
            <vs-textarea v-model="attractmilsim" label="Are you apart of any other communities, if so which ones?"
      ...
      <tab-content title="Step 3" class="mb-5">
        <div class="vx-col md:w-1/2 w-full">
          <vs-textarea v-model="attractmilsim" label="Where did you hear about us from?"
                       class="mb-0 md:mt-10 mt-6" rows="3"/>
        </div>
        <h5>By selecting "Submit", you agree that you have you read, understood, and accepted all of Rules set forth
          within the <a
            href="https://www.guilded.gg/Iceberg-gaming/groups/v3j2vAP3/channels/08ca311e-66fb-45ce-bbbf-c4b34dc69e4a/docs/2016850748"
            target="_blank">Community Code of Conduct</a>.</h5>
