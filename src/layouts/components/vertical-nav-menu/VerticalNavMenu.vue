    ...
    <vs-sidebar
      ...
      <div @mouseenter="mouseEnter" @mouseleave="mouseLeave">
        ...
        <component v-if="currentUser" :is="scrollbarTag" ref="verticalNavMenuPs"
          ...
          <NavigationBarItemsCustom :verticalNavMenuItemsMin="verticalNavMenuItemsMin" class="scroll-area-v-nav-menu pt-2"/>
...
import NavigationBarItemsCustom from "@/layouts/components/vertical-nav-menu/NavigationBarItemsCustom";

export default {
  name: 'v-nav-menu',
  components: {
    NavigationBarItemsCustom,
    VNavMenuGroup,
    VNavMenuItem,
    VuePerfectScrollbar,
    Logo
